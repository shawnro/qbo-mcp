...
toolHandlers.set("create_class", (client, args, context) => handleCreateClass(client, args as Parameters<typeof handleCreateClass>[1], context));
toolHandlers.set("get_class", (client, args, context) => handleGetClass(client, args as { id: string }, context));
toolHandlers.set("edit_class", (client, args, context) => handleEditClass(client, args as Parameters<typeof handleEditClass>[1], context));
